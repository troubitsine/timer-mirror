        ...
        <div className="w-[calc(100%-20px)] lg:w-[65vw] min-w-[300px] max-w-[1800px] max-h-[1200px] mx-auto flex flex-col gap-4 sm:gap-6">
          ...
          <div className="w-full flex flex-col items-center sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6">
            <div className="rounded-xl relative text-center sm:text-left space-y-1 max-w-md">
              <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-neutral-50/90">
                Session Complete
              </h1>
              <p className="text-sm sm:text-md text-balance text-neutral-200/80">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button
                variant="secondary"
                onClick={() => navigate("/")}
                className="w-fit bg-white/75 hover:bg-white/65 before:absolute before:inset-0 before:bg-gradient-to-b before:from-transparent before:to-black/20 before:rounded-full text-black/70 backdrop-blur-md flex items-center justify-center gap-2 rounded-full inner-stroke-white-20-sm px-[11px] py-[6px]"
              >
                Start New Timer
              </Button>
            </div>
